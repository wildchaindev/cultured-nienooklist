pub contract TweetNFT {
  ...
  // Declare the NFT resource type
    ...
    pub resource NFTMinter {
        ...
        // and, instead of depositing the NFT into a specific storage location,
    ...
    init() {
        ...
        self.account.save(<-self.createEmptyCollection(), to: /storage/TweetNFTCollection)

        // publish a reference to the Collection in storage
        self.account.link<&{NFTReceiver}>(/public/NFTReceiver, target: /storage/TweetNFTCollection)

        // store a minter resource in account storage
        self.account.save(<-create NFTMinter(), to: /storage/TweetNFTMinter)
